  ...
  spec: {
    ...
    build: {
      ...
      options: {
        ...
        '#withMachineType':: d.fn(help='Compute Engine machine type on which to run the build. Possible values: ["UNSPECIFIED", "N1_HIGHCPU_8", "N1_HIGHCPU_32"]', args=[d.arg(name='machineType', type=d.T.string)]),
