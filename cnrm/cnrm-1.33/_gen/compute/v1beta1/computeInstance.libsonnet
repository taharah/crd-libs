{
  ...
  spec: {
    ...
    '#withCanIpForward':: d.fn(help='Immutable. Whether sending and receiving of packets with non-matching source or destination IPs is allowed.', args=[d.arg(name='canIpForward', type=d.T.boolean)]),
